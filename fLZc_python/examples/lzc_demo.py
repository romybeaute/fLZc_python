...
s = "010110101001011010100101101010010110101001011010100101101010"
...
c78_dict, dict78 = flzc.calculate_lz78_with_dict(s)  # Needs implementation
...
# Get MATLAB-style normalisation factors (with +1 indexing)
